...
The code for training, evaluation and inference for both `QCPG` and `QP` is located in the dedicated directory. Scripts for reproducing the experiments can be found in the `scripts` directory inside the models directories. 
